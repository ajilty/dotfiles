...
- **One question at a time.** When input is needed, give a fork with options and a recommendation, never "what do you think?". Show the reasoning: examine the options, recommend one, and call out considerations to avoid. Batch review questions rather than asking piecemeal.
